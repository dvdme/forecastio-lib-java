...
public class FIOCsv {
	...
	private static final String[] namesForCurrently = {"time",
		"summary",
		"icon",
	...
	private final String[] namesForMinutely = {"time",
			"precipIntensity",
			"precipIntensityError",
			"precipProbability",
	"precipType"};
	
	private final String[] namesForHourly = {"time",
			"summary",
			"icon",
			"precipIntensity",
			"precipProbability",
	...
	private final String[] namesForDaily = {"time",
			"summary",
			"icon",
			"sunriseTime",
			"sunsetTime",
